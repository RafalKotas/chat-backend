...
**My Account → Security → Tokens → Generate Token**
- Choose any name
- Type: User Token
...
Stops execution — no point continuing without a token.
...
✔️ Correct approach: **token is not hardcoded**

✔️ Secure: the token lives only in the environment

✔️ Works on CI/CD in the same way
...
➡️ “Look inside `target/classes` for Java bytecode”
...
## ✅ Summary of What the Script Automates

| Task                                  | Handled by script   |
|---------------------------------------|--------------------:|
| Ensure token exists                   |                   ✅ |
| Run full Maven lifecycle              |                   ✅ |
| Run tests with coverage               |                   ✅ |
| Generate JaCoCo report                |                   ✅ |
| Upload analysis to SonarQube          |                   ✅ |
| Avoid exposing your token in the repo |                   ✅ |
