...
## 📡 Broadcasting Logic (SimpMessagingTemplate)
...
- WebSocket concerns → ChatController
- Persistence → MessageService
- Entity mapping → Message and MessageResponse
- Real-time delivery → SimpMessagingTemplate
...
### 🔹 1. Deliver messages including metadata
...
### 🔹 3. Add message editing / deleting
Extend controller with additional STOMP endpoints.

### 🔹 4. Restrict broadcasts to authenticated users
