...
### ✔ a place for future business rules

Examples of responsibilities that may be added soon:
- filtering banned or deleted messages
- applying message transformations (markdown → HTML, sanitization, emojis)
...
### ✔ decoupling controllers from persistence
